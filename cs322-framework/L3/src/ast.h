...
namespace L3
{
	...
	struct defineNode { static constexpr sv_t kw { KW::DEFINE }; };

	struct LParNode { static constexpr sv_t kw { KW::LPAR }; };
	struct RParNode { static constexpr sv_t kw { KW::RPAR }; };
	struct LCBNode  { static constexpr sv_t kw { KW::LCB }; };
	struct RCBNode  { static constexpr sv_t kw { KW::RCB }; };

	struct OpAssignNode { static constexpr sv_t kw { KW::OP_ASSIGN }; };

	struct loadNode  { static constexpr sv_t kw { KW::LOAD  }; };
	struct storeNode { static constexpr sv_t kw { KW::STORE }; };

	struct returnNode { static constexpr sv_t kw { KW::RETURN }; };
	struct brNode     { static constexpr sv_t kw { KW::BR }; };
	...
	struct OpMulNode { static constexpr sv_t kw { KW::OP_MUL }; };
	struct OpAndNode { static constexpr sv_t kw { KW::OP_AND }; };
	struct OpLshNode { static constexpr sv_t kw { KW::OP_LSH }; };
	struct OpRshNode { static constexpr sv_t kw { KW::OP_RSH }; };
	struct OpLtNode  { static constexpr sv_t kw { KW::OP_LT }; };
	struct OpLeNode  { static constexpr sv_t kw { KW::OP_LE }; };
	struct OpEqNode  { static constexpr sv_t kw { KW::OP_EQ }; };
	struct OpGeNode  { static constexpr sv_t kw { KW::OP_GE }; };
	struct OpGtNode  { static constexpr sv_t kw { KW::OP_GT }; };
	...
	struct NNode
	{
		static inline const std::regex re { "[+-]?[0-9][0-9]*" }; 
		std::int64_t val;
	};

	struct cmpNode
	{
		enum class Id: int { LT=0, LE, EQ, GE, GT, };
		static inline constexpr std::array< sv_t, 5 >
			KWS { KW::LT, KW::LE, KW::EQ, KW::GE, KW::GT, };
	...
	struct opNode
	{
		enum class Id: int { ADD=0, SUB, MUL, AND, LSH, RSH, };
		static inline constexpr std::array< sv_t, 6 >
			KWS { KW::ADD, KW::SUB, KW::MUL, KW::AND, KW::LSH, KW::RSH };

		Id id {};
	};

	using uNode = std::variant< varNode, lNode >;
